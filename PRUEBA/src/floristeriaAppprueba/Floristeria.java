...
public class Floristeria implements Serializable {
	...
	public void mostrarStock() {
		...
		/*
		 * System.out.println("Árboles:"); for (Arbol arbol : arboles) {
		 * System.out.println(arbol); } System.out.println("Flores:"); for (Flor flor :
		 * flores) { System.out.println(flor); } System.out.println("Decoraciones:");
		 * for (Decoracion decoracion : decoraciones) { System.out.println(decoracion);
		 * }
		 */
	}
